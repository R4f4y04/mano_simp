...
class SimulationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isInstructionMode =
        simulationProvider.simulationState.isInstructionMode;
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          actions: [
            ...
            // Toggle between instruction and simulation modes
            IconButton(
              icon: Icon(
                  isInstructionMode ? Icons.developer_board : Icons.school),
              tooltip: isInstructionMode
        ...
        body: Column(
          children: [
            ...
            // Conditional UI based on the mode
                          ...
                          actions: [
                            ...
                            DropdownAction(
                              ...
                              onPressed: () {
                                ...
                                if (arIndex != -1) {
                                  int arValue = simulationProvider
                                      .registers[arIndex].value;
                            ...
                            DropdownAction(
                              ...
                              onPressed: () {
                                ...
                                if (arIndex != -1 && acIndex != -1) {
                                  int arValue = simulationProvider
                                      .registers[arIndex].value;
                                  int acValue = simulationProvider
                                      .registers[acIndex].value;
                                  ...
                                  simulationProvider.simulationState
